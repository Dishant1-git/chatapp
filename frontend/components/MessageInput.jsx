...
export default function MessageInput({
  ...
  return (
    <div className="shrink-0 bg-panel pb-[var(--safe-bottom)] [&>div:last-child]:pb-[max(0.625rem,var(--safe-bottom))]">
      {replyingTo && (
      ...
      {isRecording && canRecordVoice ? (
        ...
        <div className="brand-header flex items-end gap-1 rounded-t-[1.75rem] px-2 py-2.5 md:px-3">
          <button
            type="button"
